...
namespace iSketch.app.Endpoints {
    ...
    public static class OpenID
    {
        public static async Task Endpoint(HttpContext con)
        {
            ...
            idP idP = Classes.OpenID.OpenIDHelpers.GetIDP(Guid.Parse(con.Request.RouteValues["IdpID"].ToString()));
            if (idP == null)
            {
            ...
            TokenHandleResult result = Classes.OpenID.OpenIDHelpers.HandleIdpIdToken(session, idP, JWT);
